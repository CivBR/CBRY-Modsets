...
UPDATE [Leaders] SET [MinorCivCompetitiveness] = [MinorCivCompetitiveness] + 1;
...
BEGIN
UPDATE Leaders
SET WonderCompetitiveness = (WonderCompetitiveness + 2), MinorCivCompetitiveness = (MinorCivCompetitiveness + 1), VictoryCompetitiveness = (VictoryCompetitiveness + 5), Boldness = (Boldness + 4)
WHERE Type = NEW.Type;
END;

UPDATE [Leader_MajorCivApproachBiases] SET [Bias] = [Bias] + 8 WHERE MajorCivApproachType = 'MAJOR_CIV_APPROACH_WAR';
