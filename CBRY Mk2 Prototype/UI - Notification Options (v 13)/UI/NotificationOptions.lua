...
g_Notifications[NotificationTypes.NOTIFICATION_DIPLOMAT_EJECTED] = {item="Diplomat", key="NOTIFICATION_DIPLOMAT_EJECTED", show=isBNW, ui=isBNW}
...
g_Notifications[NotificationTypes.NOTIFICATION_ADD_REFORMATION_BELIEF] = {item="AddReformationBelief", key="NOTIFICATION_ADD_REFORMATION_BELIEF", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_CALL_FOR_PROPOSALS] = {item="LeagueCallForProposals", key="NOTIFICATION_LEAGUE_CALL_FOR_PROPOSALS", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CHOOSE_ARCHAEOLOGY] = {item="ChooseArchaeology", key="NOTIFICATION_CHOOSE_ARCHAEOLOGY", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_CALL_FOR_VOTES] = {item="LeagueCallForVotes", key="NOTIFICATION_LEAGUE_CALL_FOR_VOTES", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_REFORMATION_BELIEF_ADDED_ACTIVE_PLAYER] = {item="ReformationBeliefAdded", key="NOTIFICATION_REFORMATION_BELIEF_ADDED_ACTIVE_PLAYER", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_REFORMATION_BELIEF_ADDED] = {item="ReformationBeliefAdded", key="NOTIFICATION_REFORMATION_BELIEF_ADDED", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_GREAT_WORK_COMPLETED_ACTIVE_PLAYER] = {item="GreatWork", key="NOTIFICATION_GREAT_WORK_COMPLETED_ACTIVE_PLAYER", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_VOTING_DONE] = {item="LeagueVotingDone", key="NOTIFICATION_LEAGUE_VOTING_DONE", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_VOTING_SOON] = {item="LeagueVotingSoon", key="NOTIFICATION_LEAGUE_VOTING_SOON", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_SOMEONE_INFLUENTIAL] = {item="CultureVictoryPositive", key="NOTIFICATION_CULTURE_VICTORY_SOMEONE_INFLUENTIAL", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO] = {item="CultureVictoryNegative", key="NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO_ACTIVE_PLAYER] = {item="CultureVictoryPositive", key="NOTIFICATION_CULTURE_VICTORY_WITHIN_TWO_ACTIVE_PLAYER", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE] = {item="CultureVictoryNegative", key="NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE_ACTIVE_PLAYER] = {item="CultureVictoryPositive", key="NOTIFICATION_CULTURE_VICTORY_WITHIN_ONE_ACTIVE_PLAYER", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CULTURE_VICTORY_NO_LONGER_INFLUENTIAL] = {item="CultureVictoryNegative", key="NOTIFICATION_CULTURE_VICTORY_NO_LONGER_INFLUENTIAL", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CHOOSE_IDEOLOGY] = {item="ChooseIdeology", key="NOTIFICATION_CHOOSE_IDEOLOGY", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_IDEOLOGY_CHOSEN] = {item="IdeologyChosen", key="NOTIFICATION_IDEOLOGY_CHOSEN", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CITY_REVOLT_POSSIBLE] = {"Generic", key="NOTIFICATION_CITY_REVOLT_POSSIBLE", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_CITY_REVOLT] = {item="Generic", key="NOTIFICATION_CITY_REVOLT", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_PROJECT_COMPLETE] = {item="LeagueProjectComplete", key="NOTIFICATION_LEAGUE_PROJECT_COMPLETE", show=isBNW, ui=isBNW}
g_Notifications[NotificationTypes.NOTIFICATION_LEAGUE_PROJECT_PROGRESS] = {item="LeagueProjectProgress", key="NOTIFICATION_LEAGUE_PROJECT_PROGRESS", show=isBNW, ui=isBNW}
