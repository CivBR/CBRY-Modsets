...
function( wParam, lParam )
	...
	elseif ( wParam == Keys.X ) then
		...
		Controls.WorldView:SetHide( not Controls.WorldView:IsHidden() );
		Controls.TopPanel:SetHide( not Controls.TopPanel:IsHidden() );
		Controls.SelectedUnitContainer:SetHide( not Controls.SelectedUnitContainer:IsHidden() );
		return true;
